...
extern class RotateTo {
     ...
     */
    public function start(radians:Float, ?shortestPath:Bool, ?duration:Float, ?ease:Dynamic, ?force:Bool, ?callback:CameraRotateCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
    /**
