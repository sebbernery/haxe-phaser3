...
extern class Zoom {
     ...
     */
    public function start(zoom:Float, ?duration:Float, ?ease:Dynamic, ?force:Bool, ?callback:phaser.types.cameras.scene2d.CameraZoomCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
    /**
