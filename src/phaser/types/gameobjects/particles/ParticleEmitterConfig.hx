...
typedef ParticleEmitterConfig = {
    ...
    @:optional var accelerationX:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var accelerationY:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var alpha:Dynamic;
    @:optional var angle:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var bounce:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var delay:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var lifespan:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var maxVelocityX:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var maxVelocityY:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var moveToX:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var moveToY:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var quantity:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var rotate:Dynamic;
    @:optional var scale:Dynamic;
    @:optional var scaleX:Dynamic;
    @:optional var scaleY:Dynamic;
    @:optional var speed:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var speedX:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
    @:optional var speedY:phaser.types.gameobjects.particles.EmitterOpOnEmitType;
