...
typedef MatterSetBodyConfig = {
    ...
    @:optional var maxSides:Float;
    @:optional var slope:Float;
    @:optional var sides:Float;
    @:optional var verts:Dynamic;
    @:optional var flagInternal:Bool;
    @:optional var removeCollinear:Float;
    @:optional var minimumArea:Float;
