...
typedef MatterDebugConfig = {
    ...
    @:optional var angleColor:Bool;
    @:optional var showBroadphase:Bool;
    @:optional var broadphaseColor:Bool;
    @:optional var showBounds:Bool;
    @:optional var boundsColor:Bool;
    @:optional var showVelocity:Bool;
    @:optional var velocityColor:Bool;
    @:optional var showCollisions:Bool;
    @:optional var collisionColor:Bool;
    @:optional var showSeparation:Bool;
    @:optional var separationColor:Bool;
