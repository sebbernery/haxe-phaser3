...
typedef MatterDebugConfig = {
    @:optional var showAxes:Bool;
    @:optional var showAngleIndicator:Bool;
    @:optional var angleColor:Float;
    @:optional var showBroadphase:Bool;
    @:optional var broadphaseColor:Float;
    @:optional var showBounds:Bool;
    @:optional var boundsColor:Float;
    @:optional var showVelocity:Bool;
    @:optional var velocityColor:Float;
    @:optional var showCollisions:Bool;
    @:optional var collisionColor:Float;
    @:optional var showSeparation:Bool;
    @:optional var separationColor:Float;
    @:optional var showBody:Bool;
    @:optional var showStaticBody:Bool;
    @:optional var showInternalEdges:Bool;
    @:optional var renderFill:Bool;
    @:optional var renderLine:Bool;
    @:optional var fillColor:Float;
    @:optional var fillOpacity:Float;
    @:optional var lineColor:Float;
    @:optional var lineOpacity:Float;
    @:optional var lineThickness:Float;
    @:optional var staticFillColor:Float;
    @:optional var staticLineColor:Float;
    @:optional var showSleeping:Bool;
    @:optional var staticBodySleepOpacity:Float;
    @:optional var sleepFillColor:Float;
    @:optional var sleepLineColor:Float;
    @:optional var showSensors:Bool;
    @:optional var sensorFillColor:Float;
    @:optional var sensorLineColor:Float;
    @:optional var showPositions:Bool;
    @:optional var positionSize:Float;
    @:optional var positionColor:Float;
    @:optional var showJoint:Bool;
    @:optional var jointColor:Float;
    @:optional var jointLineOpacity:Float;
    @:optional var jointLineThickness:Float;
    @:optional var pinSize:Float;
    @:optional var pinColor:Float;
    @:optional var springColor:Float;
    @:optional var anchorColor:Float;
    @:optional var anchorSize:Float;
    @:optional var showConvexHulls:Bool;
    @:optional var hullColor:Float;
};
