...
typedef MatterBodyConfig = {
    ...
    @:optional var parts:Array<Dynamic>;
    @:optional var plugin:Dynamic;
    @:optional var angle:Float;
    @:optional var vertices:Array<phaser.types.math.Vector2Like>;
    @:optional var position:phaser.types.math.Vector2Like;
    @:optional var force:phaser.types.math.Vector2Like;
    @:optional var torque:Float;
    @:optional var isSensor:Bool;
    @:optional var isStatic:Bool;
    @:optional var sleepThreshold:Float;
    @:optional var density:Float;
    @:optional var restitution:Float;
    @:optional var friction:Float;
    @:optional var frictionStatic:Float;
    @:optional var frictionAir:Float;
    @:optional var collisionFilter:phaser.types.physics.matter.MatterCollisionFilter;
    @:optional var slop:Float;
    @:optional var timeScale:Float;
    @:optional var chamfer:Dynamic;
    @:optional var circleRadius:Float;
    @:optional var mass:Float;
    @:optional var inverseMass:Float;
    @:optional var scale:phaser.types.math.Vector2Like;
    @:optional var gravityScale:phaser.types.math.Vector2Like;
    @:optional var ignoreGravity:Bool;
    @:optional var ignorePointer:Bool;
    @:optional var render:phaser.types.physics.matter.MatterBodyRenderConfig;
    @:optional var onCollideCallback:Dynamic;
    @:optional var onCollideEndCallback:Dynamic;
    @:optional var onCollideActiveCallback:Dynamic;
    @:optional var onCollideWith:Dynamic;
};
