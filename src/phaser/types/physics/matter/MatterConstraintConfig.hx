...
typedef MatterConstraintConfig = {
    ...
    @:optional var bodyA:Dynamic;
    @:optional var bodyB:Dynamic;
    @:optional var pointA:phaser.types.math.Vector2Like;
    @:optional var pointB:phaser.types.math.Vector2Like;
    @:optional var stiffness:Float;
    @:optional var angularStiffness:Float;
    @:optional var angleA:Float;
    @:optional var angleB:Float;
    @:optional var damping:Float;
    @:optional var length:Float;
    @:optional var plugin:Dynamic;
    @:optional var render:phaser.types.physics.matter.MatterConstraintRenderConfig;
};
