...
typedef TimelineBuilderConfig = {
    @:optional var tweens:Dynamic;
    @:optional var targets:Dynamic;
    ...
    @:optional var onStart:phaser.types.tweens.TimelineOnStartCallback;
    @:optional var onStartScope:Dynamic;
    @:optional var onStartParams:Array<Dynamic>;
    @:optional var onUpdate:phaser.types.tweens.TimelineOnUpdateCallback;
    @:optional var onUpdateScope:Dynamic;
    @:optional var onUpdateParams:Array<Dynamic>;
    @:optional var onLoop:phaser.types.tweens.TimelineOnLoopCallback;
    @:optional var onLoopScope:Dynamic;
    @:optional var onLoopParams:Array<Dynamic>;
    @:optional var onYoyo:phaser.types.tweens.TimelineOnYoyoCallback;
    @:optional var onYoyoScope:Dynamic;
    @:optional var onYoyoParams:Array<Dynamic>;
    @:optional var onComplete:phaser.types.tweens.TimelineOnCompleteCallback;
