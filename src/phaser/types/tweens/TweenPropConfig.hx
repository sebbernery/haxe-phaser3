...
typedef TweenPropConfig = {
    ...
    @:optional var getActive:phaser.types.tweens.GetActiveCallback;
    @:optional var getEnd:phaser.types.tweens.GetEndCallback;
    @:optional var getStart:phaser.types.tweens.GetStartCallback;
