...
var game:phaser.Game;
    ...
    @:optional var vertShader:String;
    @:optional var fragShader:String;
    @:optional var batchSize:Float;
    @:optional var vertexSize:Float;
    @:optional var vertices:Dynamic;
    @:optional var attributes:phaser.types.renderer.webgl.WebGLPipelineAttributesConfig;
    @:optional var shaders:Array<phaser.types.renderer.webgl.WebGLPipelineShaderConfig>;
    @:optional var forceZero:Bool;
    @:optional var renderTarget:Dynamic;
};
