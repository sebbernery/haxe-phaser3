...
var callback:phaser.types.renderer.snapshot.SnapshotCallback;
    ...
    @:optional var isFramebuffer:Bool;
    @:optional var bufferWidth:Float;
    @:optional var bufferHeight:Float;
};
