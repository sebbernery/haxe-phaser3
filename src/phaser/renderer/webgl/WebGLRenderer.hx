...
extern class WebGLRenderer {
    ...
    public function setTextureFilter(texture:Int, filter:Int):phaser.renderer.webgl.WebGLRenderer;
    public function setFloat1(program:js.html.webgl.Program, name:String, x:Float):phaser.renderer.webgl.WebGLRenderer;
    public function setFloat2(program:js.html.webgl.Program, name:String, x:Float, y:Float):phaser.renderer.webgl.WebGLRenderer;
    public function setFloat3(program:js.html.webgl.Program, name:String, x:Float, y:Float, z:Float):phaser.renderer.webgl.WebGLRenderer;
    public function setFloat4(program:js.html.webgl.Program, name:String, x:Float, y:Float, z:Float, w:Float):phaser.renderer.webgl.WebGLRenderer;
    public function setInt1(program:js.html.webgl.Program, name:String, x:Int):phaser.renderer.webgl.WebGLRenderer;
    public function setInt2(program:js.html.webgl.Program, name:String, x:Int, y:Int):phaser.renderer.webgl.WebGLRenderer;
    public function setInt3(program:js.html.webgl.Program, name:String, x:Int, y:Int, z:Int):phaser.renderer.webgl.WebGLRenderer;
    public function setInt4(program:js.html.webgl.Program, name:String, x:Int, y:Int, z:Int, w:Int):phaser.renderer.webgl.WebGLRenderer;
    public function setMatrix2(program:js.html.webgl.Program, name:String, transpose:Bool, matrix:js.html.Float32Array):phaser.renderer.webgl.WebGLRenderer;
    public function setMatrix3(program:js.html.webgl.Program, name:String, transpose:Bool, matrix:js.html.Float32Array):phaser.renderer.webgl.WebGLRenderer;
    public function setMatrix4(program:js.html.webgl.Program, name:String, transpose:Bool, matrix:js.html.Float32Array):phaser.renderer.webgl.WebGLRenderer;
