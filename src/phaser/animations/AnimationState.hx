 ...
 */
@:native("Phaser.Animations.AnimationState")
extern class AnimationState {
     ...
     * @since 3.24.0
     */
    public var nextAnimsQueue:Array<Dynamic>;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function load(key:Dynamic):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function playAfterDelay(key:Dynamic, delay:Float):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function playAfterRepeat(key:Dynamic, ?repeatCount:Float):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function play(key:Dynamic, ?ignoreIfPlaying:Bool):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function playReverse(key:Dynamic, ?ignoreIfPlaying:Bool):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function startAnimation(key:Dynamic):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function setRepeat(value:Float):phaser.gameobjects.GameObject;
    /**
     ...
     */
    public function globalRemove(?key:String, ?animation:phaser.animations.Animation):Void;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function restart(?includeDelay:Bool, ?resetRepeats:Bool):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function complete():phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function stopAfterDelay(delay:Float):phaser.gameobjects.GameObject;
    /**
     ...
     * @return {Phaser.GameObjects.GameObject} The Game Object that owns this Animation Component.
     */
    public function stopAfterRepeat(?repeatCount:Float):phaser.gameobjects.GameObject;
    /**
