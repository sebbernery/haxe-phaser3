...
extern class Text extends phaser.gameobjects.GameObject {
    public function new(scene:phaser.Scene, x:Float, y:Float, text:Dynamic, style:phaser.types.gameobjects.text.TextStyle);
    /**
     ...
     * @since 3.0.0
     */
    public var padding:phaser.types.gameobjects.text.TextPadding;
    /**
     ...
     * @return {this} This Text object.
     */
    public function setMaxLines(?max:Float):Dynamic;
    /**
